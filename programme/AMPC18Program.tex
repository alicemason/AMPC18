...
\subsubsection{Installing Java Runtime
Environment}\label{installing-java-runtime-environment}

Please note: You will need to install JRE (Java Runtime Environment).
You can do this from \url{https://java.com}.
...
\textgreater{}\textgreater{} Sys.setenv(JAVA\_HOME =
`/Library/Java//Home')

\textgreater{}\textgreater{} Sys.setenv(LD\_LIBRARY\_PATH =
`\(LD_LIBRARY_PATH:\)JAVA\_HOME/lib')
